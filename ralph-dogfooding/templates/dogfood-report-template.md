...
<!-- Copy this block for each issue. Interactive issues need step-by-step screenshots. Static issues (typos, visual glitches) only need a single screenshot — set Repro Video to N/A. -->
