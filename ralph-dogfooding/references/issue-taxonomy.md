...
Reference for categorizing issues found during dogfooding. Read at the start of a session to calibrate what to look for.
...
8. **Auth boundaries** — Test when not logged in, and with different roles if applicable.
